					...
					<div class="wrap-product-detail">
						...
						<div class="detail-info">
                            ...
                            <div class="short-desc">
                                {{$product->short_descripton}}
                            </div>
                            <div class="wrap-social">
                            	<a class="link-socail" href="#"><img src="{{asset('assets/images/social-list.png')}}" alt=""></a>
                            </div>
							@if ($product->sale_price > 0)
                            <div class="wrap-price"><span class="product-price">Rs.{{$product->sale_price}}</span><span style="text-decoration: line-through;" class="product-price regprice">Rs. {{$product->regular_price}}</span></div>
                                ...
                                <li class="product-item">
									<div class="product product-widget-style">
										...
										<div class="product-info">
											...
											<div class="wrap-price"><span class="product-price">Rs.{{$popular_product->regular_price}}</span></div>
										</div>
									</div>
								</li>
                                @endforeach
							...
							<div class="products slide-carousel owl-carousel style-nav-1 equal-container" data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"3"},"1200":{"items":"5"}}' >
								...
								<div class="product product-style-2 equal-elem ">
									...
									<div class="product-info">
										...
										<div class="wrap-price"><span class="product-price">Rs.{{$related_product->regular_price}}</span></div>
									</div>
								</div>
                                @endforeach
							</div>
