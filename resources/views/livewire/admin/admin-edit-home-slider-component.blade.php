            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        @endif
                        <form class="form-horizontal" action="" wire:submit.prevent="updateSlide" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input wire:model="newimage" type="file" name="" id="" class="input-file" placeholder="Slider Image">
                                    @if ($newimage)
