            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        @endif
                        <form class="form-horizontal" action="" wire:submit.prevent="addProduct" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input wire:model="image" type="file" name="" id="" class="input-file" placeholder="Product Image">
                                    @if ($image)
